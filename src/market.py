...
class Market:
    ...
    def __init__(self, settings: Settings, config: Config):
        ...
        self.market_settings = settings.get_settings_group('general', 'market', 'mpc')
        ...
        AM_estimator_config = {'dep_lags': list(range(48,  3*96 + 48, 4)),    'indep_lags': list(range(0,  3*96 + 0,  4)), 'training_window': [-30*QUARTER_HOURS_PER_DAY, -1*QUARTER_HOURS_PER_DAY]}
